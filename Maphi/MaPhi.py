    ...
    if not os.path.exists(mol_path):
        ...
        with open(save_path,'a+') as data_file:
            ...
            for k in molecules_F:
                ...
                subprocess.call(openbabel + str("\t-imopout\t") + str("molecule_opt.out") + str("\t-omol\t") + "-O" + "molecule.mol", shell=True)
                subprocess.call(openbabel + str("\t-imopout\t") + str("molecule_opt.out") + str("\t-osmi\t") + "-O" + "molecule.smi   " + param.ph, shell=True)

...
def check_mol_struct(obabel, molepath, mopacEXE):
    ...
    for k in molecules_F:
        ...
        subprocess.call(obabel + str("\t-imol2\t") + molecule_path + "/" + molecule_file + str("\t-omol2\t") + "-O" + molecule_path + "/" + molecule_file, shell=True)
        print("##############################################################################################")
        ...
        subprocess.call(obabel + str("\t-imopout\t") + molepath + "/" + str("molecule_opt.out") + str("\t-omol\t") + "-O" + molepath + "/" + "molecule.mol", shell=True)
        ...
        if Chem.MolFromMolFile(molepath + "/" + str("molecule.mol")) is None:
            ...
            subprocess.call(obabel + str("\t-imol\t") + "molecule.mol" + str("\t-osmi\t") + "-O" + molecule_file + ".smi", shell=True)
